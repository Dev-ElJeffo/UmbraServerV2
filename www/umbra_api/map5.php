...
<head>
    <meta charset="UTF-8">
    <title>2D Map Visualization (map5.php)</title>
    <style>
        canvas {
...
<body>
    <h1>2D Map Visualization (map5.php)</h1>
    ...
    <script>
        try {
            ...
            const scale = 0.03; // 1000 units -> 30 pixels
            const offsetX = 300;
            const offsetY = 1000;
            ...
            maps.forEach(map => {
                ...
                const size = 4800 * scale; // 4800 units -> 144 pixels
                ...
                ctx.fillText(map.name, canvasX, canvasY - size / 2 - 20); // Offset above rectangle
            });
