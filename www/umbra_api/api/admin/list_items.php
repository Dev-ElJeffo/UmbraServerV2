...
$data = trim((string)$json) === '' ? [] : admin_decode_json_body($json);
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    $data['type'] = $_GET['type'] ?? ($data['type'] ?? null);
    $data['rarity'] = $_GET['rarity'] ?? ($data['rarity'] ?? null);
    $data['search'] = $_GET['search'] ?? ($data['search'] ?? null);
    $data['equipment_slot'] = $_GET['equipment_slot'] ?? ($data['equipment_slot'] ?? null);
}
