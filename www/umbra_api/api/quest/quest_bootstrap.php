<?php
/**
 * Dependências comuns para api/quest/*.php
 */
...
$qh = $umbraApiRoot . DIRECTORY_SEPARATOR . 'helpers' . DIRECTORY_SEPARATOR . 'quest_helper.php';

foreach ([
    $db => 'config/database.php',
    $jwt => 'helpers/jwt_helper.php',
    $psh => 'helpers/personal_shop_helper.php',
    $nvh => 'helpers/npc_vendor_helper.php',
    $qh => 'helpers/quest_helper.php',
] as $path => $label) {
    if (!is_readable($path)) {
