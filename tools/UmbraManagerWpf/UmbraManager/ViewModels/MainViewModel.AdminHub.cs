...
public partial class MainViewModel
{
    ...
    [ObservableProperty] private float _newNpcCombatStopRange = 0f;
    ...
    partial void OnNewNpcCombatStopRangeChanged(float value) => OnPropertyChanged(nameof(NpcDesignerSummary));
