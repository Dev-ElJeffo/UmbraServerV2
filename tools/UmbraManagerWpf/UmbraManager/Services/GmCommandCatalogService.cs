...
public static class GmCommandCatalogService
{
    ...
    [
        ...
        new() { Scope = "zone", Name = "broadcast", Description = "Envia mensagem administrativa para todos da zone.", ArgsHint = "message=\"Servidor reinicia em 5 min\"", Example = "broadcast message=\"Servidor reinicia em 5 min\"" },
